    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div class="flex gap-4">
              <div>
                ...
                <div
                  class="w-[100%] h-[230px] overflow-hidden"
                  v-if="
                    dataUserById?.identification?.identificationImageFrontUrl
                  "
                >
                  <img
                    :src="
          ...
          <div class="mt-[2.1rem]">
            ...
            >
              <img
                :src="
                  dataUserById?.identification?.identificationImageSelfieUrl
                "
                alt=""
      ...
      <div class="flex justify-end items-center p-5">
        <a-button
          type="primary"
          @click="acceptAccount"
          :disabled="dataUserById?.status == 'ACTIVE'"
          >Phê duyệt tài khoản</a-button
        >
      </div>
    </div>
  </div>
