...
const validate = () => {
  ...
  errors.value.categoryId = inputProduct.value.categoryId ? '' : 'Danh mục không được để trống'
  errors.value.defaultLevelId = inputProduct.value.defaultLevelId ? '' : 'Level mặc định không được để trống'
  return !errors.value.name && !errors.value.fileUpload && !errors.value.sku && !errors.value.price && !errors.value.priceUnit && !errors.value.status && !errors.value.description && !errors.value.categoryId && !errors.value.defaultLevelId
}
...
<template>
  ...
  >
    ...
    <div>
      <a-modal v-model:visible="visible" width="1000px" title="Thêm sản phẩm" @ok="handlAddProduct">
        ...
        <div>
          ...
          <div class="mt-1">
            <a-input v-model:value="inputProduct.name" placeholder="Tên sản  phẩm "/>
          </div>
        ...
        <div class="mt-2">
          ...
          <span class="text-red-500 font-medium italic text-sm"> {{ errors.sku }}</span>
        </div>
        ...
        <div class="mt-2">
          ...
          <span class="text-red-500 font-medium italic text-sm"> {{ errors.categoryId }}</span>
        </div>
        ...
        <div class="py-2 inline-block min-w-full ">
          <div class="overflow-hidden">
            <table class="min-w-full">
              ...
              <tbody v-for="(itemLevel,indexProduct) in dataProduct" :key="indexProduct">
              <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100 ">
                ...
                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                  <div class="w-[100px] h-[100px] overflow-hidden">
                    <img :src="itemLevel.imageList[0]" alt="" class="w-full h-full object-cover">
                  </div>
                </td>
  ...
  <a-modal v-model:visible="visibleEdit" width="1000px" title="Sửa danh mục" @ok="handlEditProduct">
    <div>
      <label class="block text-sm font-medium text-gray-700">
        Tên sản phẩm
      </label>
