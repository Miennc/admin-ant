    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
      <div class="px-5 py-2">
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Tên sản phẩm</div>
          <div>
            {{ dataProduct?.name }}
          </div>
        </div>
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Giá sản phẩm</div>
          <div>
            {{ dataProduct?.price }}
          </div>
        </div>
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Mô tả sản phẩm</div>
          <div>
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Mã sản phẩm</div>
          <div>
            {{ dataProduct?.sku }}
          </div>
        </div>
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Giảm giá</div>
          <div v-if="dataProduct?.displaySale">Giảm giá</div>
          <div v-else>Không giảm</div>
        </div>

        <div class="bg-[#e5e7eb] h-[1px] my-2"></div>

        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Thuộc danh mục</div>
          <div>
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Đơn vị giá</div>
          <div>
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Tốc độ tối đa</div>
          <div>
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Tốc độ tối thiểu</div>
          <div>
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Level</div>
          <div>
        ...
        <div class="flex gap-5">
          ...
          <td
            v-if="dataProduct?.status == 'ACTIVE'"
          ...
          <td
            v-if="dataProduct?.status == 'DELETE'"
            class="text-sm font-medium text-black font-light whitespace-nowrap"
          >
            <a-tag color="yellow"> Đã xóa</a-tag>
          </td>
          <td
            v-if="dataProduct?.status == 'INACTIVE'"
        ...
        <div class="flex gap-5 mt-2">
          <div class="text-[#111827] font-[500]">Ảnh sản phẩm</div>
        </div>
        <div class="flex flex-wrap">
          <div
            v-for="(itemImg, index) in dataProduct.imageList"
            :key="index"
