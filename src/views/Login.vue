    ...
    <div class="lg:w-1/2 xl:max-w-screen-sm">
      <div class="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
        <div class="cursor-pointer flex items-center">
          ...
          <div class="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">Name Project</div>
        </div>
      </div>
          ...
          <form @submit.prevent="handleLogin">
            <div>
              ...
              <input v-model="userName"
                     ...
                     type="" placeholder="manhne">
              <span class="text-red-500 italic font-medium text-sm">{{ errors.userName }}</span>
            </div>
            <div class="mt-8">
              ...
              <span class="text-red-500 italic font-medium text-sm">{{ errors.password }}</span>
            </div>
            <div class="mt-10">
