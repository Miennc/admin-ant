...
const validate = () => {
  errors.value.name = inputUsers.value.name
    ? ""
    : "Tên người dùng không được để trống";
  errors.value.email = emailRegex.test(inputUsers.value.email)
    ? ""
    : "Email không đúng định dạng";
  errors.value.password = inputUsers.value.password
    ? ""
    : "Mật khẩu không được để trống";
  errors.value.userName = inputUsers.value.userName
    ? ""
    : "Tên đăng nhập không được để trống";
  errors.value.phone = phoneRegex.test(inputUsers.value.phone)
    ? ""
    ...
    <div>
      ...
      >
        ...
        <div class="mt-2">
          ...
          <div class="mt-1">
            <a-input
              v-model:value="inputUsers.userName"
        ...
        <div class="mt-2">
          ...
          <div class="mt-1">
            <a-input-password
              v-model:value="inputUsers.password"
        ...
        <div class="mt-2">
          ...
          <div class="mt-1">
            <a-input
              v-model:value="inputUsers.phone"
            ...
            <table class="min-w-full">
              ...
              <tbody v-for="(itemUser, indexUser) in dataUser" :key="indexUser">
                ...
                >
                  ...
                  <router-link
                    :to="{ name: 'userDetail', query: { id: itemUser.id } }"
                  >
                  ...
                  >
                    <div class="flex justify-start items-center">
                      <span @click="showModalEdit(itemUser.id)"
                        ><i
                      ...
                      <span
                        @click="showModalConfirm(itemUser.id)"
