    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
      <div class="px-5 py-2">
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Tiêu đề</div>
          <div>
            {{ dataNew?.title }}
          </div>
        </div>
        ...
        <div class="flex gap-5">
          <div class="text-[#111827] font-[500]">Nội dung</div>
          <div>
            {{ dataNew?.content }}
          </div>
        </div>
        ...
        <div class="flex gap-5">
          ...
          <td
            v-if="dataNew?.status == 'DELETE'"
            class="text-sm font-medium text-black font-light whitespace-nowrap"
          >
            <a-tag color="yellow"> Đã xóa</a-tag>
          </td>
          <td
            v-if="dataNew?.status == 'INACTIVE'"
        ...
        <div class="flex gap-5 mt-2">
          <div class="text-[#111827] font-[500]">Ảng sản phẩm</div>
        </div>
        <div class="flex flex-wrap">
          <div
            v-for="(itemImg, index) in dataNew.attachmentList"
            :key="index"
