...
const validate = () => {
  errors.value.name = inputCate.value.name
    ? ""
    : "Tên danh mục không được để trống";
  errors.value.description = inputCate.value.description
    ? ""
                ...
                >
                  ...
                  >
                    <div class="flex justify-start items-center">
                      <span @click="showModalEdit(itemCate.id)"
                        ><i
                      ...
                      <span
                        @click="showModalConfirm(itemCate.id)"
